...
- [Physically Based Rendering:From Theory To Implementation (PBRTv4 BOOK)](https://pbr-book.org/)
...
## RANDOM RESOURCE
There are over 2,000 references in Real-Time Rendering 4th Edition, which together provide extensive coverage of the field of interactive computer graphics. So a fun (albeit inefficient) way to learn about computer graphics is to randomly select one reference.
- https://www.realtimerendering.com/random.html
